...
public class ExportObj : MonoBehaviour {
    ...
    private string MeshToString(MeshFilter mf, Vector3 scale,bool hdr = true)
    {
        Mesh mesh = mf.mesh;
        ...
        if (hdr)
        {
            textureOffset = mf.GetComponent<Renderer>().material.GetTextureOffset("_DetailMap");
            textureScale = mf.GetComponent<Renderer>().material.GetTextureScale("_DetailMap");
        }
        else
        {
            textureOffset = mf.GetComponent<Renderer>().material.GetTextureOffset("_MainTex");
            textureScale = mf.GetComponent<Renderer>().material.GetTextureScale("_MainTex");
        }
